...
8. Added the About-page team section at the client's request (§11). Now two cards, confirmed by the client: Kasozi Aloisius (Founder & Lead Developer) and Mugisha Andrew (Co-Founder & Software Engineer). Mugisha Andrew's headshot is cropped to a 512px square at `src/assets/team/mugisha-andrew.jpg`; Kasozi Aloisius's is at `src/assets/team/kasozi-aloisius.jpg`.
